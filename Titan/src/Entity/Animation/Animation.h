...
public:
	...
	bool loop;	// loop показвает зациклена ли анимаци€. Ќапример анимаци€ взрыва должна проигратьс€ один раз и остановитьс€, loop=false
	bool flip, isPlaying;
	sf::Sprite sprite;
